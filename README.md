...
# How To Use:
* Run ``setup_new_problem.sh`` with ``./setup_new_problem.sh`` in bash to setup a new problem directory with the ``Template.cpp`` file and a generated compile script in it
